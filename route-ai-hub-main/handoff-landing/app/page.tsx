  ...
  return (
    <div>
      ...
      <main className="mx-auto max-w-7xl px-4">
        <Hero />
        <SectionSeparator />
        {/* Solid gradient band before Issues */}
        <div className="h-16 md:h-20 bg-gradient-to-b from-[#0B111A] via-[#0E1420] to-[#111827]" aria-hidden="true" />
        <Issues />
        {/* Solid gradient band after Issues */}
        <div className="h-16 md:h-20 bg-gradient-to-b from-[#0B111A] via-[#0E1420] to-[#111827]" aria-hidden="true" />
        <SectionSeparator />
        <WhatWeDo />
        <Features />
