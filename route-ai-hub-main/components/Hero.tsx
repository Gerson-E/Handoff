...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-[92svh] flex items-center justify-center py-24 md:py-32 bg-gradient-to-b from-[#0A0F1C]/80 via-[#0B101C]/60 to-transparent backdrop-saturate-150"
    >
